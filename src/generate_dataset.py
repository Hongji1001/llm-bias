...
def worker_prompt(worker_id, prompts, sentences, categories_dict,
                  results_queue):
    results = []
    for prompt, sentence in tqdm(zip(prompts, sentences),
                                 total=len(prompts),
...
def main():
    ...
    # file_name = Path(
    #     __file__).resolve().parent.parent / 'data' / "realtoxic_false.json"
