...
from transformers import (AutoModelForCausalLM,
                          ...
                          GPT2Config, GPT2Model, GPT2Tokenizer, XLNetLMHeadModel, XLNetTokenizer,
                          PreTrainedModel)
...
def load_model_Generation(type="raw", model_name=None, model_path=None):
    """
    ...
    if type == "raw":
        ...
        raise ValueError("Invalid phase specified. Choose either 'train' or 'test'.")
