###
 ...
 # @LastEditTime: 2024-06-04 17:36:42
...
CUDA_VISIBLE_DEVICES=3 python generation_benchmark.py --model_name_or_path /data1/TxPLM/llm-bias/checkpoint/llama2_unlearned --datasets bookcorpus_new.jsonl
CUDA_VISIBLE_DEVICES=3 python generation_benchmark.py --model_name_or_path /data1/TxPLM/llm-bias/checkpoint/llama2_unlearned --datasets cnn_dailymail_new.jsonl
CUDA_VISIBLE_DEVICES=3 python generation_benchmark.py --model_name_or_path /data1/TxPLM/llm-bias/checkpoint/llama2_unlearned --datasets bold.jsonl