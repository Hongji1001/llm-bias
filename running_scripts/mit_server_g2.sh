###
 ...
 # @LastEditTime: 2024-06-03 16:11:55
...
CUDA_VISIBLE_DEVICES=2 python llm_unlearn/unlearn_harm.py --model_name $model_path --model_save_dir models/llama2_unlearned --log_file logs/llama2-unlearn.log --use_lora
