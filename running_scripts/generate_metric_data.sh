###
 ...
 # @LastEditTime: 2024-06-11 09:59:16
...
CUDA_VISIBLE_DEVICES=0 python generation_benchmark_no_metric.py --model_name_or_path /data1/TxPLM/llm-bias/checkpoint/llama3 --datasets cnn_dailymail_new.jsonl
CUDA_VISIBLE_DEVICES=0 python generation_benchmark_no_metric.py --model_name_or_path /data1/TxPLM/llm-bias/checkpoint/llama3 --datasets bold.jsonl
CUDA_VISIBLE_DEVICES=0 python generation_benchmark_no_metric.py --model_name_or_path /data1/TxPLM/llm-bias/checkpoint/llama3 --datasets bookcorpus_new.jsonl
