###
 ...
 # @LastEditTime: 2024-06-06 11:23:38
...
# CUDA_VISIBLE_DEVICES=1 python generation_benchmark_only_metric.py --model_name_or_path /data1/TxPLM/llm-bias/checkpoint/llama2_cnn_dailymail_new_UNLEARN  --datasets bookcorpus_new.jsonl --bias_types national
...
# CUDA_VISIBLE_DEVICES=1 python generation_benchmark_only_metric.py --model_name_or_path $model_path --datasets bold.jsonl

# CUDA_VISIBLE_DEVICES=1 python generation_benchmark_only_metric.py --model_name_or_path /data1/TxPLM/llm-bias/checkpoint/llama2_bookcorpus_new_UNLEARN --datasets cnn_dailymail_new.jsonl --bias_types socioeconomic lgbt appearance class education disability nationa

# CUDA_VISIBLE_DEVICES=1 python generation_benchmark_only_metric.py --model_name_or_path /data1/TxPLM/llm-bias/checkpoint/llama2_unlearned  --datasets cnn_dailymail_new.jsonl --bias_types bodyshame socioeconomic lgbt appearance class education disability national
