###
 ...
 # @LastEditTime: 2024-06-06 05:18:16
...
# CUDA_VISIBLE_DEVICES=2 python generation_benchmark_no_metric.py --model_name_or_path /data1/TxPLM/llm-bias/checkpoint/llama2_bookcorpus_new_UNLEARN --datasets bold.jsonl
...
CUDA_VISIBLE_DEVICES=2 python generation_benchmark_no_metric.py --model_name_or_path /data1/TxPLM/llm-bias/checkpoint/llama2_unlearned  --datasets cnn_dailymail_new.jsonl bodyshame socioeconomic lgbt appearance class education disability national
