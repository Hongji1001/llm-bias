...
CUDA_VISIBLE_DEVICES=1 python llm-unlearning/unlearn_harm.py --model_name meta-llama/Meta-Llama-3-8B-instruct $model_path --model_save_dir checkpoint/llama3 --log_file logs/llama3-unlearn.log --use_lora
